...
for data in ['DPT', 'YAN', 'Deng']:
    ...
    parser.add_argument('--datasetDir', type=str, default='../scGNN/Data/trajectory/{}/'.format(data),
    ...
    parser.add_argument('--LTMGDir', type=str, default='../scGNN/Data/trajectory/{}/'.format(data),
...
for dataset in ['DPT', 'YAN', 'Deng', 'Buettner']:
    ...
    parser.add_argument('--datasetDir', type=str, default='../scGNN/Data/trajectory/',
    ...
    parser.add_argument('--outputDir', type=str, default='trajectoryout/{}/'.format(dataset),
    ...
    # LTMG related
    parser.add_argument('--LTMGDir', type=str, default='../scGNN/Data/trajectory/{}/'.format(dataset),
                        help='directory of LTMGDir, default:(/home/wangjue/biodata/scData/allBench/)')
