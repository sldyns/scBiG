...
for data in ['10X_PBMC','mouse_bladder_cell','mouse_ES_cell','human_kidney_counts','Adam','Human_pancreatic_islets','Macosko_mouse_retina']:
    ...
    parser.add_argument('--datasetDir', type=str, default='../scGNN/Data/real/{}/'.format(data),
    ...
    parser.add_argument('--LTMGDir', type=str, default='../scGNN/Data/real/{}/'.format(data),
...
for dataset in ['10X_PBMC','mouse_bladder_cell','mouse_ES_cell','human_kidney_counts','Adam','Human_pancreatic_islets','Macosko_mouse_retina']:
    ...
    parser.add_argument('--datasetDir', type=str, default='../scGNN/Data/real/',
    ...
    parser.add_argument('--outputDir', type=str, default='realout/{}/'.format(dataset),
    ...
    # LTMG related
    parser.add_argument('--LTMGDir', type=str, default='../scGNN/Data/real/{}/'.format(dataset),
                        help='directory of LTMGDir, default:(/home/wangjue/biodata/scData/allBench/)')
